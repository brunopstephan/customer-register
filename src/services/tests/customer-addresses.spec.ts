...
describe('Customer Contacts', () => {
  ...
  it('should create a customer contract', async () => {
  ...
  it('should update a customer contract', async () => {
    jest.spyOn(repositoryMock, 'update')
  ...
  it('should delete a customer contract', async () => {
    jest.spyOn(repositoryMock, 'update')
  ...
  it('should throw a 404 error when contract not found', async () => {
    const { statusCode: deleteStatusCode } =
